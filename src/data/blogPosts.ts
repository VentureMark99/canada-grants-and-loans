    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If your application is identified as a strong candidate during our initial intake call, we can typically have your Digital Adoption Plan ready for submission within 10 business days. Call us at 1-855-GRANTS-5 to find out if your business qualifies.",
        ],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Call us at 1-855-GRANTS-5 for a free intake call. We'll tell you within 20 minutes what programmes we think you're eligible for and what the process looks like.",
        ],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The Complete Package is $2,500, all-inclusive — business plan, pitch deck, and 10 grant applications, with no page limits, unlimited revisions, and delivery in both PDF and editable formats. Call us at 1-855-GRANTS-5 to get started.",
        ],
      },
    ],
